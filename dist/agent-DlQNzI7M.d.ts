 ...
 */
type StopReason = "budget" | "max_tokens" | "timeout" | "user_cancellation" | "cancelled" | "other" | (string & {});
...
declare class StreamingContext {
    ...
    readonly streamReasoning: boolean;
...
declare class Network<T extends StateData> {
     ...
     */
    history?: HistoryConfig<T>;
    constructor({ name, description, agents, defaultModel, maxIter, defaultState, router, defaultRouter, stopWhen, parallelAgents, history, }: Network.Constructor<T>);
...
declare namespace Network {
     ...
     */
    type StopWhen<T extends StateData> = (args: StopWhen.Args<T>) => MaybePromise<NetworkStop | undefined | false>;
    namespace StopWhen {
        interface Args<T extends StateData> {
 ...
 */
declare function createTool<TName extends string, TInput extends Tool.Input, TOutput, TState extends StateData>({ name, description, parameters, manualStep, parallelSafe, handler, }: {
    name: TName;
    description?: string;
    parameters?: TInput;
    /**
...
declare class Agent<T extends StateData> {
     ...
     */
    run(input: UserMessage | string, { model, network, state, maxIter, maxIterPerRun, streaming, streamingContext, step, signal, }?: Agent.RunOptions<T> | undefined): Promise<AgentResult>;
...
export { type StepFailedEvent as $, Agent as A, type ThreadOperationConfig as B, type SaveThreadToStorageConfig as C, DEFAULT_MAX_ITER_PER_RUN as D, initializeThread as E, loadThreadFromStorage as F, saveThreadToStorage as G, type HistoryConfig as H, type ImageContent as I, FINAL_APPEND_STEP_ID as J, incrementalAppendStepId as K, persistResults as L, type Message as M, Network as N, type AgentMessageChunk as O, AgentMessageChunkSchema as P, type StopReason as Q, type ReasoningDetail as R, type StateData as S, Tool as T, type UserMessage as U, type RunStartedEvent as V, type RunCompletedEvent as W, type RunFailedEvent as X, type RunInterruptedEvent as Y, type StepStartedEvent as Z, type StepCompletedEvent as _, createRoutingAgent as a, type PartCreatedEvent as a0, type PartCompletedEvent as a1, type PartFailedEvent as a2, type TextDeltaEvent as a3, type ToolCallArgumentsDeltaEvent as a4, type ToolCallOutputDeltaEvent as a5, type ReasoningDeltaEvent as a6, type DataDeltaEvent as a7, type HitlRequestedEvent as a8, type HitlResolvedEvent as a9, type UsageUpdatedEvent as aa, type MetadataUpdatedEvent as ab, type StreamEndedEvent as ac, type GenericErrorEvent as ad, DEFAULT_CHUNK_SIZE as ae, DEFAULT_MAX_CHUNKS_PER_MESSAGE as af, type StreamingConfig as ag, StreamingContext as ah, type StreamingEvent as ai, isEventType as aj, generateId as ak, createStepWrapper as al, RoutingAgent as b, createAgent as c, createNetwork as d, NetworkRun as e, createState as f, getDefaultRoutingAgent as g, State as h, type ToolResultPayload as i, createTool as j, createToolManifest as k, MCP as l, type MaybePromise as m, type AnyZodType as n, getStepTools as o, isInngestFn as p, getInngestFnInput as q, type TextMessage as r, stringifyError as s, type ReasoningMessage as t, type ToolCallMessage as u, type ToolResultMessage as v, type TextContent as w, type ToolMessage as x, AgentResult as y, History as z };
