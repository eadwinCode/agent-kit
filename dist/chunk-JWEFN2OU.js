    ...
    if (tool.parameters) {
      try {
        inputSchema = jsonSchema(
          z.toJSONSchema(tool.parameters, { target: "draft-7" })
        );
      } catch (e) {
...
var AgentMessageChunkSchema = z2.object({
  event: z2.string(),
  data: z2.record(z2.string(), z2.any()),
  timestamp: z2.number(),
  sequenceNumber: z2.number(),
  id: z2.string()
});
    ...
    tools: [
      createTool({
        ...
        parameters: z3.object({
          ...
          reason: z3.string().optional().describe("Brief explanation of why this agent was chosen")
        }).strict(),
      ...
      createTool({
        ...
        manualStep: true,
        parameters: z3.object({
          summary: z3.string().optional().describe("Brief summary of what was accomplished")
        }).strict(),
        handler: ({ summary }) => {
...
//# sourceMappingURL=chunk-JWEFN2OU.js.map