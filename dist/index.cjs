...
var NetworkRun = class extends Network {
  ...
  async execute(...[input, overrides]) {
    ...
    if ((_c = this.history) == null ? void 0 : _c.appendUserMessage) {
      let userMessage;
    ...
    if (streamingPublish) {
      streamingContext = StreamingContext.fromNetworkState(this.state, {
        ...
        scope: "network",
        simulateChunking: (_d = overrides == null ? void 0 : overrides.streaming) == null ? void 0 : _d.simulateChunking,
        chunkSize: (_e = overrides == null ? void 0 : overrides.streaming) == null ? void 0 : _e.chunkSize,
        maxChunksPerMessage: (_f = overrides == null ? void 0 : overrides.streaming) == null ? void 0 : _f.maxChunksPerMessage,
        streamReasoning: (_g = overrides == null ? void 0 : overrides.streaming) == null ? void 0 : _g.streamReasoning
      });
